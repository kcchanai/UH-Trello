...
const files = [
  ...
  'src/auth-ui.js', 'src/cloud-workspace-ui.js', 'src/adapters/adapter-contract.js', 'src/adapters/local-workspace-adapter.js',
...
const limits = {
  ...
  'src/auth-ui.js': 8_000, 'src/cloud-workspace-ui.js': 8_000, 'src/adapters/adapter-contract.js': 8_000,
