...
if (!cloudUI.includes('summary.append(title,detail)') || !cloudUI.includes('actions.prepend(button)')) throw new Error('Archived workspace identity must remain visible when Open is suppressed.');
